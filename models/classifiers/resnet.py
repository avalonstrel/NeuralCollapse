...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.bn1 = NormLayer(tmp_inputs.size()[1:], norm_type)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes)
        tmp_inputs = self.conv2(tmp_inputs)
        self.bn2 = NormLayer(tmp_inputs.size()[1:], norm_type)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        tmp_inputs = self.conv3(tmp_inputs)
        self.bn3 = NormLayer(tmp_inputs.size()[1:], norm_type)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.stride = stride
