...
BLOCK_DICT = {
    'senet34':SEBasicBlock,
    'senet50':SEBottleneck,
    'senet101':SEBottleneck,
}
...
class SENetClassifier(nn.Module):
    ...
    def __init__(self, num_classes, model_type='resnet50', pretrained=False):
        super().__init__()
        assert model_type in SENET_DICT, f'Unrecognized {model_type}'
        _resnet = SENET_DICT[model_type](pretrained=pretrained)
